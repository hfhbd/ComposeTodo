    ...
    sourceSets {
        ...
        val jsMain by getting {
            dependencies {
                ...
                implementation("org.jetbrains:kotlin-react-router-dom:5.2.0-pre.138-kotlin-1.4.21")
                implementation("org.jetbrains:kotlin-react:17.0.1-pre.137-kotlin-1.4.21")
                implementation("org.jetbrains:kotlin-react-dom:17.0.1-pre.138-kotlin-1.4.21")
            }
        }
